...
# Sort indices based on actual ranks for the current experiment with tie-handling. Ref: https://stackoverflow.com/questions/39059371/can-numpys-argsort-give-equal-element-the-same-rank
def rankmin(x):
